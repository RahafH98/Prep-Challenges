...
function gradesAvg(arr) {
    ...
    return arr.map((student) => {
        const avg = student.gradsList.reduce((sum, grade) => sum + grade, 0) / student.gradsList.length;
        return { ...student, avg };
    });
}
var students = [
...
const output3 = gradesAvg(students);
console.log(output3);
// -------------------------------------------------------------------------------------------------------
...
var students2 = [
  ...
  const output4 = studentsResult(students2);
  console.log(output4);
// -------------------------------------------------------------------------------------------------------
