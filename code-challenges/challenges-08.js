...
const output = customerAndAge(customers);
console.log(output);
...
const getEntries = (obj) => {
  ...
  for (const [key, value] of Object.entries(obj)) {
    const entryString = `${key}: ${Array.isArray(value) ? value.join(",") : value}`;
...
const result2 = getEntries(recipeInfo);
console.log(result2);
// -------------------------------------------------------------------------------------------------------
...
const getInfo = (arr) => {
  ...
  for (const course of arr) {
    ...
    //push the course property value into the coursesName array
    //then use the spread operator (...) to push all the elements of the Students array into the studentsName array
...
const names = ['Kalé', 'Alisha', 'Alphonso', 'Briana'];
const result3 = getStudents(names);
console.log(result3);
//  ------------------------------------------------------------------------------------------------------
